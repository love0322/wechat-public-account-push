export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx48435a2e78f4a5fa",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "a5db37806e3d4922905ac1008ae7d849",
  ...
  USERS: [
    {
      ...
      id: "os4d75k69QWW9BEvW9DG5zYpI3_c",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "dROC_64OR2aia8yAjbkCF6MmcDVBdiB0-M7u1VtGEyk",
      // 所在省份
      province: "湖北",
      // 所在城市
      city: "巴东",
      ...
      customizedDateList: [
        // 在一起的日子
        {"keyword": "love_day", date: "2014-03-22"},
        // 结婚纪念日
        {"keyword": "marry_day", date: "2021-10-05"},
